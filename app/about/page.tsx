export default function AboutPage() {
    ...
    <div className="max-w-3xl mx-auto px-6 py-8">
      <h1 className="text-lg font-semibold mb-1">What is GAKE?</h1>
      ...
      <section className="mb-10">
        <h2 className="text-sm uppercase tracking-widest text-blue-400 mb-3 border-b border-zinc-800/60 pb-2">
        ...
        <div className="space-y-3 text-sm text-zinc-400 leading-relaxed">
          <p>
            ...
            forecast, a <span className="text-emerald-400">GAP FOUND</span> badge appears.
          </p>
          <p>
            ...
            toward <span className="text-red-400">NO</span> on unlikely outcomes (cheaper,
            higher win-rate) with one <span className="text-emerald-400">YES</span> position
          ...
          <p>
            <span className="text-zinc-300 font-medium">How to use it:</span> click a card
      ...
      <section className="mb-10">
        ...
        <div className="space-y-3 text-sm text-zinc-400 leading-relaxed">
          ...
          <p>
            <span className="text-zinc-300 font-medium">How to use it:</span> watch the{" "}
            <span className="text-emerald-400">FRESH</span> list for a market where a whale
            ...
            manually. You are not holding until settlement; you&apos;re trading the pricecorrection itself.
          </p>
        </div>
      </section>
